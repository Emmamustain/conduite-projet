    ...
    <div className={`${animationClass} transition-all duration-300`}>
      ...
      >
        ...
        <g>
          {/* Left arm */}
          <path
            d="M 35 70 H 20 C 18 70 15 70 15 75 C 15 80 18 80 20 80 H 35"
            stroke="#CCCCCC"
            strokeWidth="5"
            strokeLinecap="round"
          />
          ...
          {/* Right arm */}
          <path
            d="M 65 70 H 80 C 82 70 85 70 85 75 C 85 80 82 80 80 80 H 65"
            stroke="#CCCCCC"
            strokeWidth="5"
            strokeLinecap="round"
          />
        ...
        <g>
          {/* Left leg */}
          <path
            d="M 42 95 V 110 C 42 112 42 115 40 115 H 38"
            stroke="#CCCCCC"
            strokeWidth="5"
            strokeLinecap="round"
          />
          ...
          {/* Right leg */}
          <path
            d="M 58 95 V 110 C 58 112 58 115 60 115 H 62"
            stroke="#CCCCCC"
            strokeWidth="5"
            strokeLinecap="round"
          />
